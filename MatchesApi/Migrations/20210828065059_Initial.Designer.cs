...
namespace Matches.Migrations
{
    ...
    [Migration("20210828065059_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Matches.Models.Match", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Matches.Models.MatchOdd", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Matches.Models.MatchOdd", b =>
                {
                    b.HasOne("Matches.Models.Match", null)
                        .WithMany("MatchOdds")
